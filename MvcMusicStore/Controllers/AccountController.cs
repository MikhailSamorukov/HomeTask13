...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly CounterHelper<PerformanceCounters> _counterHelper;
        private const string XsrfKey = "XsrfId";

        private UserManager<ApplicationUser> _userManager;

        public AccountController(ILogger logger)
            : this(logger, new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext())))
        {
            _counterHelper = PerformanceHelper.CreateCounterHelper<PerformanceCounters>("Test counters");
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    _counterHelper.Increment(PerformanceCounters.SuccessLogIn);
        ...
        public async Task<ActionResult> Disassociate(string loginProvider, string providerKey)
        {
            ...
            if(!result.Succeeded)
            _logger.Error($"An error has occurred. details: {result.Errors}, loginProvider: {loginProvider}, providerKey: {providerKey}");
        ...
        public ActionResult LogOff()
        {
            ...
            _counterHelper.Increment(PerformanceCounters.SuccessLogOf);
